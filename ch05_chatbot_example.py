...
openai.api_key = "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"
...
def create_prompt(df, query):
    ...
    system_role = f"""You are an artificial intelligence language model named "소울" that specializes in summarizing \
